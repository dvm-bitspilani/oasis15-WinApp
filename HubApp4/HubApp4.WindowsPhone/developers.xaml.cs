...
namespace HubApp4
{
    ...
    /// </summary>
    public sealed partial class developers : Page
    {
        ...
        {
            string uriToLaunch = @"http://en.wikipedia.org/wiki/APOGEE_%28festival%29";
        ...
        {
            string number = "+918503987302";
            string name = "Shivani Mittal";
        ...
        {
            string number = "+918503999757";
            string name = "Anubhav Gupta";
            PhoneCallManager.ShowPhoneCallUI(number, name);
        }
