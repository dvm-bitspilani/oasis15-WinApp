...
namespace HubApp4
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        private void AboutTheFest_Click(object sender, RoutedEventArgs e)
        {
        ...
        {
            string uri1 = @"https://www.google.co.in/maps/@28.359317,75.588102,15.74z";
            DefaultLaunch(uri1);
        }

        private void ScheduleButton_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(GroupedItemsPage1));
        }
